...
| 项 | 值 |
| --- | --- |
| slug | `fillpack-screenshot-keshav` |
| `paper_reading.json` 路径 | `/home/conanxin/.openclaw/workspace/projects/paper-three-pass-reader-skill/runs/fill-pack-smoke-20260615/fillpack-screenshot-keshav/work/paper_reading.json` |
...
python3 skills/paper-three-pass-reader/scripts/render_page.py \
  --input /home/conanxin/.openclaw/workspace/projects/paper-three-pass-reader-skill/runs/fill-pack-smoke-20260615/fillpack-screenshot-keshav/work/paper_reading.json \
  --output /home/conanxin/.openclaw/workspace/projects/paper-three-pass-reader-skill/runs/fill-pack-smoke-20260615/fillpack-screenshot-keshav/paper-reading-output
```
...
python3 skills/paper-three-pass-reader/scripts/audit_paper_reading.py \
  --input /home/conanxin/.openclaw/workspace/projects/paper-three-pass-reader-skill/runs/fill-pack-smoke-20260615/fillpack-screenshot-keshav/work/paper_reading.json --json-output /home/conanxin/.openclaw/workspace/projects/paper-three-pass-reader-skill/runs/fill-pack-smoke-20260615/fillpack-screenshot-keshav/work/audit_result.json
```
...
./skills/paper-three-pass-reader/scripts/publish_output_to_github.sh \
  ...
  --branch gh-pages \
  --message "Publish fillpack-screenshot-keshav"
```

> 不要在没有真实阅读过论文之前发布。弱输入可以发布，但页面顶部 reading mode badge 必须如实显示 `screenshot_only`。
