...
> **弱输入提醒**：`reading_mode = screenshot_only`。Pass 2 main ideas 只能在 abstract 范围内写。**不要**写出"我们读了 Section 3.2，发现 X"这种假装读过 body 的句子。如果 abstract 没提到 main idea，留 `[DRAFT]` 并在 `notes` 里说明。
