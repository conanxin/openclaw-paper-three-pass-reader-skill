...
> **Weak-input note**: `reading_mode = abstract_only`. Five Cs can only be a *skeleton* based on abstract + metadata. `correctness` / `clarity` should carry `[Needs verification]`.
