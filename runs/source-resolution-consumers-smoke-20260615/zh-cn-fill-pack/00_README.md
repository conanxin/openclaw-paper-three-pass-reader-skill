...
| --- | --- |
| slug | `runs` |
| `paper_reading.json` 路径 | `runs/source-resolution-consumers-smoke-20260615/zh-cn-matched-paper_reading.json` |
...
- **输入线索**:`Attention Is All You Need`
- **解析状态**:`matched`
- **匹配类型**:`title`
- **置信度**:`high`
- **匹配论文**:`Attention Is All You Need`
- **匹配 arXiv ID**:`1706.03762`
- **匹配仓库**:`(none)`
- **解析来源**:`skills/paper-three-pass-reader/data/resolver_hints.json`
- **解析步骤**:`cli overlay via p3pr paper_title subcommand`
- **候选数量**:`1`
...
python3 skills/paper-three-pass-reader/scripts/render_page.py \
  --input runs/source-resolution-consumers-smoke-20260615/zh-cn-matched-paper_reading.json \
...
python3 skills/paper-three-pass-reader/scripts/audit_paper_reading.py \
  --input runs/source-resolution-consumers-smoke-20260615/zh-cn-matched-paper_reading.json --json-output runs/source-resolution-consumers-smoke-20260615/audit_result.json
```
