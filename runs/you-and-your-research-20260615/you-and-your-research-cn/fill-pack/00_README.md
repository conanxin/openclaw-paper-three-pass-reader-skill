...
| `paper_reading.json` 路径 | `runs/you-and-your-research-20260615/you-and-your-research-cn/work/paper_reading.json` |
...
- **匹配类型**:`url`
- **置信度**:`high`
- **匹配论文**:`You and Your Research`
- **匹配 arXiv ID**:`(none)`
- **匹配仓库**:`(none)`
- **解析来源**:`user_supplied_url`
- **解析步骤**:`url -> html_fetch -> text_extraction -> full_text`
- **候选数量**:`0`
...
python3 skills/paper-three-pass-reader/scripts/render_page.py \
  --input runs/you-and-your-research-20260615/you-and-your-research-cn/work/paper_reading.json \
...
python3 skills/paper-three-pass-reader/scripts/audit_paper_reading.py \
  --input runs/you-and-your-research-20260615/you-and-your-research-cn/work/paper_reading.json --json-output runs/you-and-your-research-20260615/you-and-your-research-cn/work/audit_result.json
```
...
./skills/paper-three-pass-reader/scripts/publish_output_to_github.sh \
  ...
  --branch gh-pages \
  --message "Publish you-and-your-research-cn"
```
